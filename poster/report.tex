...
%% Abstract section.
\abstract{
  Computer simulations of the effect of earthquakes on built structures promise to let engineers understand different trade offs and designs at an attractively low cost.
